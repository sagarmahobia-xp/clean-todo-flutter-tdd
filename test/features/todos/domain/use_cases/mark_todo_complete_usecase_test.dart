...
void main() {
  ...
  group('Group- Domain - MarkTodoCompleteUseCase', () {
    ...
    test('should mark todo as complete using the repository', () async {
      // arrange
      when(() => mockTodoRepo.markComplete(todo.id)).thenAnswer((_) async => null);
    ...
    test('should return failure when repository throws exception', () async {
      // arrange
      when(() => mockTodoRepo.markComplete(todo.id)).thenThrow(Exception("Failed to mark todo as complete"));
